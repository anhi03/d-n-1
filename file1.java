 ...
 * @author Admin
 */
public class file1 extends javax.swing.JInternalFrame {
    ...
    void showData(int i){
        ...
        txt_Maphong.setText(tbl_phong.getValueAt(i, 1).toString());
        txt_dientich.setText(tbl_phong.getValueAt(i, 2).toString());
        cbo_typeroom.setSelectedItem(tbl_phong.getValueAt(i, 3).toString());
        txt_price.setText(tbl_phong.getValueAt(i, 4).toString());
        txt_mota.setText(tbl_phong.getValueAt(i, 5).toString());
        if(tbl_phong.getValueAt(i, 6).toString().equalsIgnoreCase("trống"))
